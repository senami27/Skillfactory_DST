...
Для отбора признаков необходимо воспользоваться 2-мя методами: RFE, SelectKBest.
...
4) Отбор столбцов с помощью рекурсивного исключения признаков (RFE) и обучение модели на них.
