...
4) Обучение модели наивного байесовского классификатора;
5) Оценка качества модели с помощью кривой ROC-AUC;
6) Оценка качества полученной модели с помощью метрики F1.
