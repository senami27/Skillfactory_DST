...
3) Реализация алгоритма координатного спуска.
4) Реализация стахостического градиентного спуска:
...
5) Оценка качества обеих полученных моделей с помощью MSE и MAE.
6) Выводы по проекту.
